...
public class inforrespon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inforrespon);
    ...
    Borrar=(Button) findViewById(R.id.btborrar);
        Borrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(banderaEdit){
                    ...
                    Borrar.setText("Borrar Responsable");
                    editar.setText("Editar Responsable");
                    banderaEdit=false;
                }else {//se borra responsable
        ...
        editar=(Button) findViewById(R.id.bteditarr);
        editar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(banderaEdit) {///se edita responsable
                    ...
                    Toast toast1 =
                            Toast.makeText(inforrespon.this,
                                    "Edite los datos que requiera y pulse aceptar", Toast.LENGTH_LONG);
...
class consulta extends AsyncTask{
    ...
    class popup{
        ...
        popup(String texto){
            AlertDialog.Builder builder1 = new AlertDialog.Builder(inforrespon.this);
