...
<html lang="en">
    ...
    <div style=' clear: both; text-align:center; position: relative;'>
        ...
        <script language="JavaScript">
            ...
            function  Registra_usuario(tipouser) {
                var nocacheurl;
                // alert(tipouser);
                var name = document.getElementById('name').value;
                var appat = document.getElementById('appat').value;
                var apmat = document.getElementById('appmat').value;
                ...
                if (tipouser == "Cliente") {
                    ...
                    nocacheurl = "funciones/AddUsers.jsp?tipouser=" + tipouser + "&name=" + name +
                            "&appat=" +appat+"&apmat=" + apmat +
                            "&calle=" +calle+"&colonia=" + colonia +
                            "&ncasa=" +ncasa+"&ciudad=" +ciudad  +
                            "&estado=" +estado+"&tel=" + tel +
                            "&usuario=" +user+"&psw=" + psw1 +
                            "&cel=" +cel+"&ingresos=" +ingresos +
                            "&email=" +email;
                ...
                ajax = nuevoAjax();
                ajax.onreadystatechange = onReadyRegistraUser;
            ...
            function onReadyRegistraUser() {

                if (ajax.readyState == 4 && ajax.readyState != null) {
                     document.getElementById("FomAdd").innerHTML = ajax.responseText; //Parametro = id del div
                ...
                <section id="content"><div class="ic"></div>
                    <div class="main">
                        <div class="container_12">
                            ...
                            <h4 class="p2">  <a href="#" onclick="mostrarAgregar()">  <img src="images/minus.png"  width="20" height="20" id="adduser"> Agregar usuario</a></h4>
                            <div class="wrapper" style='display:none;' id='Agregar'>
                                ...
                                <article class="grid_10">                          
                                    <div class="wrapper" id="FomAdd">
                                        <article class="grid_10">
                                            <!--AGREGAR USUARIOS--  -->    <div class="indent-left"  id='Formulario'>
                            ...
                            <h4 class="p2" >  <a href="#" onclick="mostrarBorrar()">  <img src="images/minus.png"  width="20" height="20" id="addSrvice" > Eliminar usuario</a></h4>
                            ...
                            <h4 class="p2" ><a href="#" onclick="mostrarModificar()">    <img src="images/minus.png"  width="20" height="20" id="addSrvice" > Modificar Usuario</a></h4>
