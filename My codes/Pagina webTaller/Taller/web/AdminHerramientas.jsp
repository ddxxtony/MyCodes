...
<html lang="en">
                ...
                <section id="content"><div class="ic"></div>
                    <div class="main">
                        <div class="container_12">
                            ...
                            <br>
                            <!--AGREGAR SERVICIO -->
                            <h4 class="p2">  <a href="#" onclick="mostrarAgregar()">  <img src="images/minus.png"  width="20" height="20" id="adduser"> Agregar Herramienta</a></h4>
                            ...
                            <h4 class="p2" >  <a href="#" onclick="mostrarBorrar()">  <img src="images/minus.png"  width="20" height="20" id="addSrvice" > Eliminar Herramienta</a></h4>
 ...
 <!-----MODIFICAR SERVICIO ---- -->
                            ...
                            <h4 class="p2" ><a href="#" onclick="mostrarModificar()">    <img src="images/minus.png"  width="20" height="20" id="addSrvice" > Modificar herramieinta</a></h4>
...
<!-- CONSULTAR HERRAMIENTAS -->
                              <h4 class="p2" ><a href="#" onclick="mostrarModificar()">    <img src="images/minus.png"  width="20" height="20" id="addSrvice" > Consultar Herramientas</a></h4>
                            <div class="wrapper p4" style='display:none;'  id='Modificar'>
                                <article class="grid_3">
                                    <label><span class="text-form">Seleccione el tipo de usuario:</span> </label>
                                    <br>
