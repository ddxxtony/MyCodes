                ...
                <section id="content"><div class="ic"></div>
                    <div class="main">
                        <div class="container_12">
                            ...
                            <br>
<!--AGREGAR SERVICIO -->
                            <h4 class="p2">  <a href="#" onclick="mostrarAgregar()">  <img src="images/minus.png"  width="20" height="20" id="adduser"> Agregar Servicio</a></h4>
            ...
            <!--OPCIONES  -->            <form id="contact-form" method="post" enctype="multipart/form-data">                    
                            ...
                            <h4 class="p2" >  <a href="#" onclick="mostrarBorrar()">  <img src="images/minus.png"  width="20" height="20" id="addSrvice" > Eliminar Servicio</a></h4>
 ...
 <!-----MODIFICAR SERVICIO ---- -->
                            ...
                            <h4 class="p2" ><a href="#" onclick="mostrarModificar()">    <img src="images/minus.png"  width="20" height="20" id="addSrvice" > Modificar SERVICIO</a></h4>
                             <div class="wrapper p4" style='display:none;'  id='Modificar'>
                                 ...
                                 <h4 class="p2">  <a href="#" onclick="mostrarAgregar()">  <img src="images/minus.png"  width="20" height="20" id="adduser"> Consultar Servicios</a></h4>
                            <div class="wrapper" style='display:none;' id='Agregar'>
