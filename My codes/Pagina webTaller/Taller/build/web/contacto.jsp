                                        ...
                                        <article class="grid_8">
                                            ...
                                            <div class="indent-left" >
                                                ...
                                                <form id="contact_form" method="post" enctype="multipart/form-data">                    
                                                    <fieldset>
                                                          <label><span class="text-form">Nombre:</span><input id='names' name="names" type="text" /></label>
                                                          <label><span class="text-form">Email:</span><input id='email' name="email" type="text" /></label>                              
                                                          <label><span class="text-form">Telefono:</span><input id='phone' name="phone" type="text" /></label>                              
                                                          <div class="wrapper">
                                                            ...
                                                            <div class="extra-wrap">
                                                                ...
                                                                <div class="clear"></div>
                                                                <div class="buttons">
                                                                    <a class="button" href="#" onClick="document.getElementById('contact_form').reset()">Limpiar</a>
                                                                     <a class="button"  onClick="Send_mail()">Enviar</a>
                                                                </div> 
                                                                <br>
